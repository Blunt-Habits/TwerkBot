...
var esBot = {
        ...
        status: true,
        name: "TwerkBOT",
        creator: "Chase/Variety",
        loggedInID: "50aeb41d877b9217e2fc9169",
        scriptLink: "http://pastebin.com/raw.php?i=DUrQwGaV",
        cmdLink: "http://goo.gl/gYA5ia",
        roomSettings: {
            maximumAfk: 240,
            afkRemoval: true,                
            maximumDc: 60,                                
            ...
            lockskipReasons: [ ["theme", "This song does not fit the room theme. "],
                    ...
                    ["off genre", "Your song is off genre for this room. "],
            ...
            welcome: true,
            opLink: "http://goo.gl/aBr22Y",
            rulesLink: "http://goo.gl/I1OqYD",
            themeLink: null,
            fbLink: null,
            youtubeLink: null,
            website: "http://TRNTrecords.com",
            intervalMessages: [],
            messageInterval: 5,
            songstats: true,                      
        },        
        room: {        
            ...
            roulette: {
                ...
                startRoulette: function(){
                    ...
                    API.sendChat("/me :sound: " + chat.from + " enabled roulette. Type !join to participate!");
                },
        ...
        userUtilities: {
                ...
                if(API.getWaitListPosition(id) === -1){                    
                    if (wlist.length < 50){
                        ...
                        if(alreadyQueued !== -1){
                            ...
                            return API.sendChat('User is already being added! Changed the desired position to ' + esBot.room.queue.position[alreadyQueued] + '.');
                        }
                        ...
                        var name = user.username;
                        return API.sendChat('Added @' + name + ' to the queue. Current queue: ' + esBot.room.queue.position.length + '.');
                    }
                }
            ...
            dclookup: function(id){
                var user = esBot.userUtilities.lookupUser(id);                        
                if(typeof user === 'boolean') return ('User not found.');
                var name = user.username;
                if(user.lastDC.time === null) return ('[' + name + '] [!dc] I have not seen you disconnect.');
                var dc = user.lastDC.time;
                var pos  = user.lastDC.position;
                if(pos === null) return ("[" + name + "] [!dc] The waitlist needs to update at least once to register the user's last position.");
                ...
                if(!validDC) return ("[" + name + "] [!dc] @" + esBot.userUtilities.getUser(user).username + "'s last disconnect (DC or leave) was too long ago: " + time + ".");
                ...
                var msg = '[' + name + '] [!dc] @' + esBot.userUtilities.getUser(user).username + ' disconnected ' + time + ' ago and should be at position ' + newPosition + '.';
                            ...
                            if(typeof user !== 'boolean'){
                                ...
                                if(rank !== null && plugUser.permission <= rank){
                                    ...
                                    if (inactivity > esBot.roomSettings.maximumAfk * 60 * 1000 ){
                                        if(warncount === 0){
                                            API.sendChat('[AFK] @' + name + ', you have been afk for ' + time + ', please respond within 2 minutes or you will be removed from the waitlist.');
                                            ...
                                            API.sendChat("[AFK] @" + name + ", 30 seconds until you will be removed.");
                                            user.afkWarningCount = 3;
                                            user.afkCountdown = setTimeout(function(userToChange){
                                            ...
                                            if(pos !== -1){
                                                ...
                                                API.sendChat('[AFK] @' + name + ', you have been removed for being afk for ' + time + '. You were at position ' + pos + '.');
                                            }
                                            user.afkWarningCount = 0;
                                        };
                                    }
        ...
        eventUserjoin: function(user){
            ...
            if(esBot.roomSettings.welcome && greet){
                setTimeout(function(){
                    API.sendChat("Hello @" + user.username + ". Welcome to TRNT!");
                }, 1*1000);
            }              
        },        
        ...
        eventDjadvance: function(obj){                
            ...
            if(esBot.roomSettings.songstats) API.sendChat("" + lastplay.media._previousAttributes.title + " | :arrow_up: " + lastplay.score.positive + " | :heart_decoration: " + lastplay.score.curates + " | :arrow_down: " + lastplay.score.negative + " |");
            ...
            for(var i = 0; i < esBot.room.historyList.length; i++){
                if(esBot.room.historyList[i][0] === obj.media.cid){
                    ...
                    API.sendChat(':repeat: This song has been played ' + plays + ' time' + interfix + ' in the last ' + esBot.roomUtilities.msToStr(Date.now() - firstPlayed) + ', last play was ' + esBot.roomUtilities.msToStr(Date.now() - lastPlayed) + ' ago. :repeat: ');
            ...
            if(esBot.roomSettings.timeGuard && newMedia.duration > esBot.roomSettings.maximumSongLength*60  && !esBot.room.roomevent){
                ...
                API.sendChat('@' + name + ', your song is longer than ' + esBot.roomSettings.maximumSongLength + ' minutes!');
                API.moderateForceSkip();
            }
            var user = esBot.userUtilities.lookupUser(obj.dj.id);
            if(user.ownSong){
                API.sendChat(':up: @' + user.username + ' has permission to play their own production!');
                user.ownSong = false;
            }
            ...
            chatFilter: function(chat){
                ...
                var plugRoomLinkPatt, sender;
                    ...
                    if (plugRoomLinkPatt.exec(msg)) {
                      ...
                      if (perm === 0) {                                                              
                              API.sendChat("@" + chat.from + ", don't post links to other rooms please.");
                              API.moderateDeleteChat(chat.cid);
                              return true;
                      }
                    }
                if(msg.indexOf('http://adf.ly/') > -1){
                    API.moderateDeleteChat(chat.cid);
                    API.sendChat('@' + chat.from + ', please change your autowoot program. We suggest PlugCubed: http://plugcubed.net/');
                    return true;
                }                    
                ...
                **/
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    if(msg.length === cmd.length) time = 60;
                                        ...
                                        if(isNaN(time)) return API.sendChat('[' + chat.from + '] [!active] Invalid time specified.');
                                    }
                                    for(var i = 0; i < esBot.room.users.length; i++){
                                    ...
                                    API.sendChat('[' + chat.from + '] [!active] There have been ' + chatters + ' users chatting in the past ' + time + ' minutes.');
                                };                              
                        },
                },
                ...
                addCommand: {
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    var msg = chat.message;
                                    if(msg.length === cmd.length) return API.sendChat('[' + chat.from + '] [!add] No user specified.');
                                    ...
                                    if (msg.length > cmd.length + 2) {
                                        ...
                                        } else API.sendChat('[' + chat.from + '] [!add] Invalid user specified.');
                                      }
                                };                              
                        },
                },
                ...
                afklimitCommand: {
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    var msg = chat.message;
                                    if(msg.length === cmd.length) return API.sendChat('[' + chat.from + '] [!afklimit] No limit specified');
                                    var limit = msg.substring(cmd.length + 1);
                                    if(!isNaN(limit)){
                                        esBot.roomSettings.maximumAfk = parseInt(limit, 10);
                                        API.sendChat('[' + chat.from + '] [!afklimit] Maximum afk duration set to ' + esBot.roomSettings.maximumAfk + ' minutes.');
                                    }
                                    else API.sendChat('[' + chat.from + '] [!afklimit] Invalid limit.');
                                };                              
                        },
                },
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    if(esBot.roomSettings.afkRemoval){
                                        ...
                                        clearInterval(esBot.room.afkInterval);
                                        API.sendChat('[' + chat.from + '] [!afkremoval] Turned afk removal off.');
                                      }
                                    else {
                                        esBot.roomSettings.afkRemoval = !esBot.roomSettings.afkRemoval;
                                        esBot.room.afkInterval = setInterval(function(){esBot.roomUtilities.afkCheck()}, 2 * 1000);
                                        API.sendChat('[' + chat.from + '] [!afkremoval] Turned afk removal on.');
                                      }
                                };                              
                        },
                },
                ...
                afkresetCommand: {
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    var msg = chat.message;
                                    if(msg.length === cmd.length) return API.sendChat('[' + chat.from + '] [!afkreset] No user specified.')
                                    var name = msg.substring(cmd.length + 2);
                                    var user = esBot.userUtilities.lookupUserName(name);
                                    if(typeof user === 'boolean') return API.sendChat('[' + chat.from + '] [!afkreset] Invalid user specified.');
                                    esBot.userUtilities.setLastActivity(user);
                                    API.sendChat('[' + chat.from + '] [!afkreset] Reset the afk status of @' + name + '.');
                                };                              
                        },
                },
                ...
                afktimeCommand: {
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    var msg = chat.message;
                                    if(msg.length === cmd.length) return API.sendChat('[' + chat.from + '] [!afktime] No user specified.');
                                    var name = msg.substring(cmd.length + 2);
                                    var user = esBot.userUtilities.lookupUserName(name);
                                    if(typeof user === 'boolean') return API.sendChat('[' + chat.from + '] [!afktime] Invalid user specified.');
                                    var lastActive = esBot.userUtilities.getLastActivity(user);
                                    var inactivity = Date.now() - lastActive;
                                    var time = esBot.roomUtilities.msToStr(inactivity);
                                    API.sendChat('[' + chat.from + '] [!afktime] @' + name + ' has been inactive for ' + time + '.');
                                };                              
                        },
                },
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    if(esBot.roomSettings.autoskip){
                                        ...
                                        clearTimeout(esBot.room.autoskipTimer);
                                        return API.sendChat('[' + chat.from + '] [!autoskip] Autoskip disabled.');
                                    }
                                    else{
                                        esBot.roomSettings.autoskip = !esBot.roomSettings.autoskip;
                                        return API.sendChat('[' + chat.from + '] [!autoskip] Autoskip enabled.');
                                    }
                                };                              
                        },
                },
                ...
                autowootCommand: {
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    API.sendChat("[' + chat.from + '] [!autowoot] We recommend PlugCubed for autowooting: http://plugcubed.net/")
                                };                              
                        },
                },
                ...
                baCommand: {
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    API.sendChat("[' + chat.from + '] [!ba] A Brand Ambassador is the voice of the plug.dj users. They promote events, engage the community and share the plug.dj message around the world. For more info: http://blog.plug.dj/brand-ambassadors/");
                                };                              
                        },
                },
                ...
                banCommand: {
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    var msg = chat.message;
                                    if(msg.length === cmd.length) return API.sendChat('[' + chat.from + '] [!ban] No valid user specified.');
                                    var name = msg.substr(cmd.length + 2);
                                    var user = esBot.userUtilities.lookupUserName(name);
                                    if(typeof user === 'boolean') return API.sendChat('[' + chat.from + '] [!ban] Invalid user specified.');
                                    API.sendChat('[' + chat.from + '] [!ban] Get the fuck out!');
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    if(esBot.roomSettings.bouncerPlus){
                                        ...
                                        return API.sendChat('[' + chat.from + '] [!bouncer+] Bouncer+ is now off.');
                                        }
                                    else{
                                        if(!esBot.roomSettings.bouncerPlus){
                                            var id = chat.fromID;
                                            ...
                                            if(perm > 2){
                                                ...
                                                return API.sendChat('[' + chat.from + '] [!bouncer+] Bouncer+ is now on.');
                                            }
                                        }
                                        else return API.sendChat('[' + chat.from + '] [!bouncer+] You have to be manager or up to enable Bouncer+.');
                                    };
                                };                              
                        },
                },
                ...
                clearchatCommand: {
                        ...
                        functionality: function(chat, cmd){
                                ...
                                return API.sendChat('[@' + chat.from + '] [!clearchat] Clearing chat!');
                ...
                commandsCommand: {
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    API.sendChat("[" + chat.from + "] [!commands] "+ esBot.name + "'s commands: " + esBot.cmdLink);
                                };                              
                        },
                },
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    if(esBot.roomSettings.cycleGuard){
                                        ...
                                        return API.sendChat('[' + chat.from + '] [!cycleguard] Cycleguard disabled.');
                                    }
                                    else{
                                        esBot.roomSettings.cycleGuard = !esBot.roomSettings.cycleGuard;
                                        return API.sendChat('[' + chat.from + '] [!cycleguard] Cycleguard enabled.');
                                    }
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    if(!isNaN(cycleTime)){
                                        ...
                                        return API.sendChat('[' + chat.from + '] [!cycleguard] The cycleguard is set to ' + esBot.roomSettings.maximumCycletime + ' minute(s).');
                                    }
                                    else return API.sendChat('[' + chat.from + '] [!cycleguard] No correct time specified for the cycleguard.');
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    if(msg.length === cmd.length) name = chat.from;
                                        ...
                                        if(perm < 2) return API.sendChat('[' + chat.from + '] [!dc] Only bouncers and above can do !dclookup for others.');
                                    }    
                                    var user = esBot.userUtilities.lookupUserName(name);
                                    if(typeof user === 'boolean') return API.sendChat('[' + chat.from + '] [!dc] Invalid user specified.');
                                    var id = user.id;
                ...
                emojiCommand: {
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    API.sendChat('[' + chat.from + '] [!emoji] http://www.emoji-cheat-sheet.com/');
                                };                              
                        },
                },
                ...
                etaCommand: {
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    var user = esBot.userUtilities.lookupUserName(name);
                                    if(typeof user === 'boolean') return API.sendChat('[' + chat.from + '] [!eta] Invalid user specified.');
                                    var pos = API.getWaitListPosition(user.id);
                                    if(pos < 0) return API.sendChat('[' + name + '] [!eta] you are not on the waitlist.');
                                    var timeRemaining = API.getTimeRemaining();
                                    var estimateMS = ((pos+1) * 4 * 60 + timeRemaining) * 1000;
                                    var estimateString = esBot.roomUtilities.msToStr(estimateMS);
                                    API.sendChat('[' + name + '] [!eta] you will reach the booth in approximately ' + estimateString + '.');                      
                                };                              
                        },
                },
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    if(typeof esBot.roomSettings.fbLink === "string")
                                        API.sendChat("[" + data.from + "] [!fb] Facebook: " + esBot.roomSettings.fbLink);
                                };                              
                        },
                },
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    if(esBot.roomSettings.filterChat){
                                        ...
                                        return API.sendChat('[' + chat.from + '] [!filter] chatfilter disabled.');
                                    }
                                    else{
                                        esBot.roomSettings.filterChat = !esBot.roomSettings.filterChat;
                                        return API.sendChat('[' + chat.from + '] [!filter] chatfilter enabled.');
                                    }
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    if(esBot.room.roulette.rouletteStatus && esBot.room.roulette.participants.indexOf(chat.fromID) < 0){
                                        ...
                                        API.sendChat("[" + chat.from + "] [!join] joined the roulette!");
                                    }
                                };                              
                        },
                },
                ...
                jointimeCommand: {
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    var msg = chat.message;
                                    if(msg.length === cmd.length) return API.sendChat('[' + chat.from + '] [!jointime] No user specified.');
                                    var name = msg.substring(cmd.length + 2);
                                    var user = esBot.userUtilities.lookupUserName(name);
                                    if(typeof user === 'boolean') return API.sendChat('[' + chat.from + '] [!jointime] Invalid user specified.');
                                    var join = esBot.userUtilities.getJointime(user);
                                    var time = Date.now() - join;
                                    var timeString = esBot.roomUtilities.msToStr(time);
                                    API.sendChat('[' + chat.from + '] [!jointime] @' + name + ' has been in the room for ' + timeString + '.');
                                };                              
                        },
                },
                ...
                kickCommand: {
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    var user = esBot.userUtilities.lookupUserName(name);
                                    var from = chat.from;
                                    if(typeof user === 'boolean') return API.sendChat('[' + from + '] [!kick] No valid user specified.');
 
                                    var permFrom = esBot.userUtilities.getPermission(chat.fromID);
                                    var permTokick = esBot.userUtilities.getPermission(user.id);
 
                                    if(permFrom <= permTokick)
                                        return API.sendChat("[' + from + '] [!kick] you can't kick users with an equal or higher rank than you!")
 
                                    if(!isNaN(time)){
                                        API.sendChat('[' + chat.from + '] [!kick] Kicking user!');
                                        API.sendChat('[' + name + '] is being kicked from the community for ' + time + ' minutes.');
                                    ...
                                    else API.sendChat('[' + from + '] [!kick] No valid time (minutes) specified.');                                  
                                };                              
                        },
                },
                ...
                killCommand: {
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    storeToStorage();
                                    API.sendChat('[' + chat.from + '] [!kill] bot was killed.');
                                    esBot.disconnectAPI();
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    if(ind > -1){
                                        ...
                                        API.sendChat("[" + chat.from + "] [!leave] left the roulette!");
                                    }
                                };                              
                        },
                },
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    if(perm >= 1 || isDj){
                                        if(media.format === '1'){
                                            ...
                                            API.sendChat('[' + from + '] [!link] Link to current song: ' + linkToSong);
                                        }
                                        if(media.format === '2'){
                                            var SCsource = '/tracks/' + media.cid;
                                            SC.get('/tracks/' + media.cid, function(sound){API.sendChat('[' + from + '] [!link] Link to current song: ' + sound.permalink_url);});
                                        }  
                                    }                    
                ...
                lockdownCommand: {
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    if(esBot.roomSettings.lockdownEnabled){
                                        return API.sendChat("[' + chat.from + '] [!lockdown] Lockdown enabled. Only staff can chat now.");
                                    }
                                    else return API.sendChat('[' + chat.from + '] [!lockdown] Lockdown disabled.');
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    if(esBot.roomSettings.lockGuard){
                                        ...
                                        return API.sendChat('[' + chat.from + '] [!lockguard] Lockguard disabled.');
                                    }
                                    else{
                                        esBot.roomSettings.lockGuard = !esBot.roomSettings.lockGuard;
                                        return API.sendChat('[' + chat.from + '] [!lockguard] Lockguard enabled.');
                                    }
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    if(esBot.room.skippable){
                                        ...
                                        if(chat.message.length === cmd.length){
                                            API.sendChat('[' + chat.from + '] [!lockskip] Lockskipping song!');
                                            //esBot.roomUtilities.booth.lockBooth();
                                            //esBot.roomUtilities.changeDJCycle();
                                            setTimeout(function(id){
                                                API.moderateForceSkip();
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    if(!isNaN(pos)){
                                        ...
                                        return API.sendChat('[' + chat.from + '] [!lockskip] Lockskip will now move the dj to position ' + esBot.roomSettings.lockskipPosition + '.');
                                    }
                                    else return API.sendChat('[' + chat.from + '] [!lockskip] No valid position specified.');
                                };                              
                        },
                },
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    if(!isNaN(lockTime)){
                                        ...
                                        return API.sendChat('[' + chat.from + '] [!lockguard] The lockguard is set to ' + esBot.roomSettings.maximumLocktime + ' minute(s).');
                                    }
                                    else return API.sendChat('[' + chat.from + '] [!lockguard] No correct time specified for the lockguard.');
                                };                              
                        },
                },
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    if(!isNaN(maxTime)){
                                        ...
                                        return API.sendChat('[' + chat.from + '] [!maxlength] The maximum song duration is set to ' + esBot.roomSettings.maximumSongLength + ' minutes.');
                                    }
                                    else return API.sendChat('[' + chat.from + '] [!maxlength] No correct duration specified.');
                                };                              
                        },
                },
                ...
                motdCommand: {
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    var msg = chat.message;
                                    if(msg.length <= cmd.length + 1) return API.sendChat('MotD: ' + esBot.roomSettings.motd);
                                    ...
                                    if(isNaN(argument)){
                                        ...
                                        API.sendChat("MotD set to: " + esBot.roomSettings.motd);
                                    }
                                    else{
                                        esBot.roomSettings.motdInterval = argument;
                                        API.sendChat('MotD interval set to ' + esBot.roomSettings.motdInterval + '.');
                                    }
                                };                              
                        },
                },
                ...
                moveCommand: {
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    var msg = chat.message;
                                    if(msg.length === cmd.length) return API.sendChat('[' + chat.from + '] [!move] No user specified.');
                                    ...
                                    var user = esBot.userUtilities.lookupUserName(name);
                                    if(typeof user === 'boolean') return API.sendChat('[' + chat.from + '] [!move] Invalid user specified.');
                                    if(user.id === esBot.loggedInID) return API.sendChat('[' + chat.from + '] [!move] Don\'t try to add me to the waitlist, please.');
                                    if (!isNaN(pos)) {
                                        API.sendChat('[' + chat.from + '] [!move] Moving user!');
                                        esBot.userUtilities.moveUser(user.id, pos, false);
                                    } else return API.sendChat('[' + chat.from + '] [!move] Invalid position specified.');
                                };                          
                        },
                },
                ...
                muteCommand: {
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    var msg = chat.message;
                                    if(msg.length === cmd.length) return API.sendChat('[' + chat.from + '] [!mute]  No user specified.');
                                    var lastSpace = msg.lastIndexOf(' ');
                                    var time = null;
                                    var name;
                                    if(lastSpace === msg.indexOf(' ')){
                                        ...
                                        time = msg.substring(lastSpace + 1);
                                        if(isNaN(time)){
                                            return API.sendChat('[' + chat.from + '] [!mute]  Invalid time specified.');
                                        }
                                        name = msg.substring(cmd.length + 2, lastSpace);
                                    }
                                    var from = chat.from;
                                    var user = esBot.userUtilities.lookupUserName(name);
                                    if(typeof user === 'boolean') return API.sendChat('[' + from + '] [!mute] Invalid user specified.');
                                    var permFrom = esBot.userUtilities.getPermission(chat.fromID);
                                    var permUser = esBot.userUtilities.getPermission(user.id);
                                    if(permFrom > permUser){
                                        esBot.room.mutedUsers.push(user.id);
                                        if(time === null) API.sendChat('[' + chat.from + '] [!mute]  Muted @' + name + '.');
                                        else{
                                            API.sendChat('[' + chat.from + '] [!mute] Muted @' + name + ' for ' + time + ' minutes.');
                                            setTimeout(function(id){
                                                ...
                                                if(indexMuted > -1){
                                                    ...
                                                    var name = u.username;
                                                    API.sendChat('[' + chat.from + '] [!unmute] Unmuted @' + name + '.');
                                                }
                                            }, time * 60 * 1000, user.id);
                                        }
                                    }
                                    else API.sendChat("[' + chat.from + '] [!mute] You can't mute persons with an equal or higher rank than you.");
                                };                              
                        },
                },
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    if(typeof esBot.roomSettings.opLink === "string")
                                        return API.sendChat("[" + chat.from + "] [!op] OP list: " + esBot.roomSettings.opLink);
                ...
                pingCommand: {
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    API.sendChat('[' + chat.from + '] [!ping] Pong!')
                                };                              
                        },
                },
                ...
                reloadCommand: {
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    API.sendChat('[' + chat.from + '] [!reload] be right back.');
                                    esBot.disconnectAPI();
                                    kill();
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    if (msg.length > cmd.length + 2) {
                                        ...
                                        } else API.sendChat("[' + chat.from + '] [!remove] Specified user @" + name + " is not in the waitlist.");
                                      } else API.sendChat("[' + chat.from + '] [!remove] No user specified.");
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    if(esBot.roomSettings.etaRestriction){
                                        ...
                                        return API.sendChat('[' + chat.from + '] [!restricteta] eta unrestricted.');
                                    }
                                    else{
                                        esBot.roomSettings.etaRestriction = !esBot.roomSettings.etaRestriction;
                                        return API.sendChat('[' + chat.from + '] [!restricteta] eta restricted.');
                                    }
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    if(typeof esBot.roomSettings.rulesLink === "string")
                                        return API.sendChat("[' + chat.from + '] [!rules] Please find the room rules here: " + esBot.roomSettings.rulesLink);                                
                                };                              
                        },
                },
                ...
                sessionstatsCommand: {
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    API.sendChat('[' + from + '] [!sessionstats] Total Woots: ' + woots + ', Total Mehs: ' + mehs + ', Total Grabs: ' + grabs + '.');
                                };                              
                        },
                },
                ...
                skipCommand: {
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    API.sendChat('[' + chat.from + '] [!skip] Skipping this song!');
                                    API.moderateForceSkip();
                                    esBot.room.skippable = false;
                                    setTimeout(function(){ esBot.room.skippable = true}, 5*1000);
                ...
                slapCommand: {
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    var space = msg.indexOf(' ');
                                    if(space === -1){
                                        API.sendChat('["+ chat.from +"] [!slap] But who?!');
                                        return false;
                                    }
                                    else{
                                        var name = msg.substring(space + 2);
                                        var user = esBot.userUtilities.lookupUserName(name);
                                        if (user === false || !user.inRoom) {
                                          return API.sendChat("["+ chat.from +"] [!slap] doesn't see '" + name + "' in room and slaps the air.");
                                        }
                                        else if(user.username === chat.from){
                                            return API.sendChat("[" + name +  "] [!slap], you want to get slapped? Ieuw, no kinky stuff please.");
                                        }
                                        else {
                                            return API.sendChat("[" + chat.from + "] [!slap], @" + user.username + ' ' + this.getSlap() );
                                        }
                                    }
                ...
                sourceCommand: {
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    API.sendChat('This bot is ran by the infamous ' + esBot.creator + '.');
                                };                              
                        },
                },
                ...
                swapCommand: {
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    var msg = chat.message;
                                    if(msg.length === cmd.length) return API.sendChat('[' + chat.from + '] [!swap] No user specified.');
                                    var firstSpace = msg.indexOf(' ');
                                    //var secondSpace = msg.substring(firstSpace + 1).indexOf(' ');
                                    var lastSpace = msg.lastIndexOf(' ');
                                    ...
                                    if(typeof user1 === 'boolean' || typeof user2 === 'boolean') return API.sendChat('[' + chat.from + '] [!swap] Invalid user specified. (No names with spaces!)');
                                    if(user1.id === esBot.loggedInID || user2.id === esBot.loggedInID) return API.sendChat('[' + chat.from + '] [!swap]  Don\'t try to add me to the waitlist, please.');
                                    var p1 = API.getWaitListPosition(user1.id);
                                    var p2 = API.getWaitListPosition(user2.id);
                                    if(p1 < 0 || p2 < 0) return API.sendChat('[' + chat.from + '] [!swap] Please only swap users that are in the waitlist!');
                                    API.sendChat("Swapping " + name1 + " with " + name2 + ".");
                                    if(p1 < p2){
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    if(typeof esBot.roomSettings.themeLink === "string")
                                        API.sendChat("Please find the permissible room genres here: " + esBot.roomSettings.themeLink);
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    if(esBot.roomSettings.timeGuard){
                                        ...
                                        return API.sendChat('[' + chat.from + '][!timeguard] Timeguard disabled.');
                                    }
                                    else{
                                        esBot.roomSettings.timeGuard = !esBot.roomSettings.timeGuard;
                                        return API.sendChat('[' + chat.from + '][!timeguard] Timeguard enabled.');
                                    }
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    if(esBot.roomSettings.motdEnabled){
                                        ...
                                        API.sendChat('[' + chat.from + '] [!motd] MotD disabled.');
                                    }
                                    else{
                                        esBot.roomSettings.motdEnabled = !esBot.roomSettings.motdEnabled;
                                        API.sendChat('[' + chat.from + '] [!motd] MotD enabled.');
                                    }
                                };                              
                        },
                },
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    setTimeout(function(chat){
                                        ...
                                        if(!found){
                                            $(".icon-chat").click();
                                            return API.sendChat('[' + chat.from + '] [!unban] The user was not banned.');  
                                        }                                
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    if(msg.indexOf('@') === -1 && msg.indexOf('all') !== -1){
                                        if(permFrom > 2){
                                            ...
                                            return API.sendChat('[' + chat.from + '] [!unmute] Unmuted everyone.');
                                        }
                                        else return API.sendChat('[' + chat.from + '] [!unmute] Only managers and up can unmute everyone at once.')
                                    }
                                    ...
                                    if(typeof user === 'boolean') return API.sendChat("[' + chat.from + '] [!unmute] Invalid user specified.");
                                    ...
                                    if(permFrom > permUser){
                                        ...
                                        if(!wasMuted) return API.sendChat("[' + chat.from + '] [!unmute] that user wasn't muted.");
                                        esBot.room.mutedUsers.splice(indexMuted);
                                        API.sendChat('[' + chat.from + '] [!unmute] Unmuted @' + name + '.');
                                    }
                                    else API.sendChat("[" + chat.from + "] [!unmute] You can't unmute persons with an equal or higher rank than you.");
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    if(!isNaN(cd)){
                                        ...
                                        return API.sendChat('[' + chat.from + '] [!usercmdcd] The cooldown for commands by users is now set to ' + esBot.roomSettings.commandCooldown + ' seconds.');
                                    }
                                    else return API.sendChat('[' + chat.from + '] [!usercmdcd] No correct cooldown specified.');
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    if(esBot.roomSettings.usercommandsEnabled){
                                        API.sendChat('[' + chat.from + '][!usercommands] Usercommands disabled.');
                                        esBot.roomSettings.usercommandsEnabled = !esBot.roomSettings.usercommandsEnabled;
                                    }
                                    else{
                                        API.sendChat('[' + chat.from + '][!usercommands] Usercommands enabled.');
                                        esBot.roomSettings.usercommandsEnabled = !esBot.roomSettings.usercommandsEnabled;
                                    }
                                };                              
                        },
                ...
                voteratioCommand: {
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    var msg = chat.message;
                                    if(msg.length === cmd.length) return API.sendChat('[' + chat.from + '] [!voteratio] No user specified.');
                                    var name = msg.substring(cmd.length + 2);
                                    var user = esBot.userUtilities.lookupUserName(name);
                                    if(user === false) return API.sendChat('[' + chat.from + '] [!voteratio] Invalid user specified.');
                                    var vratio = user.votes;
                                    var ratio = vratio.woot / vratio.meh;
                                    API.sendChat('[' + chat.from + '] [!voteratio] @' + name + ' ~ Woots: ' + vratio.woot + ', Mehs: ' + vratio.meh + ', Ratio (w/m): ' + ratio.toFixed(2) + '.');
                                };                              
                        },
                },
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    if(esBot.roomSettings.welcome){
                                        ...
                                        return API.sendChat('[' + chat.from + '] [!welcome] welcome message disabled.');
                                    }
                                    else{
                                        esBot.roomSettings.welcome = !esBot.roomSettings.welcome;
                                        return API.sendChat('[' + chat.from + '] [!welcome] welcome message enabled.');
                                    }
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    if(typeof esBot.roomSettings.website === "string")
                                        API.sendChat('[' + chat.from + '] [!website] Please visit our website: ' + esBot.roomSettings.website);
                                };                              
                        },
                },
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    if(typeof esBot.roomSettings.youtubeLink === "string")
                                        API.sendChat('[' + chat.from + '] [!youtube] Subscribe to us on YouTube: ' + esBot.roomSettings.youtubeLink);                                
                                };                              
                        },
                },
